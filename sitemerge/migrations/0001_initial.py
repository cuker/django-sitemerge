...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sitemerge_contentmerge', (
            ...
            ('src_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contentmerge_sources', to=orm['sites.Site'])),
            ('dst_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contentmerge_destinations', to=orm['sites.Site'])),
            ('task_id', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
        ))
        db.send_create_signal('sitemerge', ['ContentMerge'])
